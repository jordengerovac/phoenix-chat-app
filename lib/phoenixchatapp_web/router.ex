defmodule PhoenixchatappWeb.Router do
  # alias PhoenixchatappWeb.PageLive
  ...
  if Application.compile_env(:phoenixchatapp, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PhoenixchatappWeb.Telemetry
